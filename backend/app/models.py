...
class Review(Base):
    ...
    followed_instruction = Column(String, nullable=True)
    code_worked = Column(String, nullable=True)
    seemed_confused = Column(String, nullable=True)
    overused_tools = Column(String, nullable=True)
